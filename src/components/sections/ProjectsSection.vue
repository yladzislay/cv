        ...
        >
          <div class="p-6">
            ...
            <div class="flex flex-wrap gap-4">
              ...
              >
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm1 16.057v-3.057h2.994c-.044 1.898-1.319 2.96-2.994 3.057zm0-5.057v-5l5 5h-5z"/>
                </svg>
                <span>Demo</span>
              </a>
            </div>
...
export default {
  ...
  setup() {
    ...
    const projects = computed(() => {
      return t('projects.items', {}, { plural: true })
    })
